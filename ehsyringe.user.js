...
// @icon        https://cdn.jsdelivr.net/gh/EhTagTranslation/EhSyringe@bde646f162fddf7c6f80525febac8a1c6fcdbd44/src/assets/logo.svg
...
var package_namespaceObject = JSON.parse('{"name":"ehsyringe","displayName":"EhSyringe","version":"2.8.3","description":"E 站注射器，将中文翻译注入到 E 站体内。","author":"EhTagTranslation","repository":{"type":"git","url":"git+https://github.com/EhTagTranslation/EhSyringe.git"},"license":"MIT","bugs":"https://github.com/EhTagTranslation/EhSyringe/issues","homepage":"https://github.com/EhTagTranslation/EhSyringe","type":"module","scripts":{"start:monkey":"webpack serve --mode=development --env type=user-script","start:ext":"webpack --mode=development --watch --env type=web-ext","start:chrome":"yarn start:ext --env vendor=chrome","start:firefox":"yarn start:ext --env vendor=firefox","build":"webpack --mode=production","build:monkey":"yarn build --env type=user-script","build:ext":"yarn build --env type=web-ext","build:chrome":"yarn build:ext --env vendor=chrome && web-ext build -s dist -a releases -n ehsyringe.chrome.zip -o","build:firefox":"yarn build:ext --env vendor=firefox && web-ext build -s dist -a releases -n ehsyringe.firefox.xpi -o","lint":"eslint ./src/**/*.ts","format":"prettier --ignore-path .gitignore --write .","clean":"rimraf dist releases"},"devDependencies":{"@babel/core":"^7.16.7","@babel/plugin-transform-runtime":"^7.16.8","@babel/preset-env":"^7.16.8","@types/chrome":"^0.0.176","@types/escape-html":"^1.0.1","@types/node":"^17.0.8","@types/tampermonkey":"^4.0.5","@types/webextension-polyfill":"^0.8.2","@typescript-eslint/eslint-plugin":"^5.9.1","@typescript-eslint/parser":"^5.9.1","babel-loader":"^8.2.3","copy-webpack-plugin":"^10.2.0","css-loader":"^6.5.1","cssnano":"^5.0.15","eslint":"^8.6.0","eslint-config-prettier":"^8.3.0","eslint-plugin-prettier":"^4.0.0","execa":"^6.0.0","html-webpack-plugin":"^5.5.0","less":"^4.1.2","less-loader":"^10.2.0","postcss":"^8.4.5","postcss-import":"^14.0.2","postcss-loader":"^6.2.1","postcss-preset-env":"^7.2.3","prettier":"^2.5.1","rimraf":"^3.0.2","semver":"^7.3.5","style-loader":"^3.3.1","ts-loader":"^9.2.6","tsconfig-paths-webpack-plugin":"^3.5.2","type-fest":"^2.9.0","typescript":"^4.5.4","web-ext":"^6.6.0","webpack":"^5.66.0","webpack-bundle-analyzer":"^4.5.0","webpack-cli":"^4.9.1","webpack-dev-server":"^4.7.3","webpack-userscript":"^2.5.8","webpack-webextension-plugin":"^0.4.1","yargs":"^17.3.1"},"dependencies":{"core-js":"^3.20.2","emoji-regex":"^10.0.0","escape-html":"^1.0.3","idb-keyval":"^6.1.0","lit-html":"^2.1.1","rxjs":"^7.5.2","tslib":"^2.3.1","typedi":"^0.10.0","webextension-polyfill":"^0.8.0"}}');
...
/******/ 	var __webpack_exports__ = __webpack_require__(1461);
/******/ 	
/******/ })()
;
